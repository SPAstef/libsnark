 ...
 */
    ...
    struct bacs_example
    {
        ...
        bacs_example(const bacs_circuit<FieldT> &circuit,
            ...
            circuit(circuit), primary_input(primary_input), auxiliary_input(auxiliary_input)
        {}

        bacs_example(bacs_circuit<FieldT> &&circuit, bacs_primary_input<FieldT> &&primary_input,
                     bacs_auxiliary_input<FieldT> &&auxiliary_input) :
            circuit(std::move(circuit)), primary_input(std::move(primary_input)),
 ...
 */
    ...
    bacs_example<FieldT> generate_bacs_example(const size_t primary_input_size,
                                               ...
                                               const size_t num_gates, const size_t num_outputs);
