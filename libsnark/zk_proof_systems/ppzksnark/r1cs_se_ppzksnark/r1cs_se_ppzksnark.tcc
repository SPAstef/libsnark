...
namespace libsnark
{
     ...
     */
        ...
        sap_instance_evaluation<libff::Fr<ppT>> sap_inst = r1cs_to_sap_instance_map_with_evaluation(
            cs, t);
     ...
     */
        ...
        libff::G1_vector<ppT> verifier_query = libff::batch_exp<libff::G1<ppT>, libff::Fr<ppT>>(
        ...
        libff::G1_vector<ppT> A_query = libff::batch_exp<libff::G1<ppT>, libff::Fr<ppT>>(
            libff::Fr<ppT>::size_in_bits(), G_window, G_table, tmp_exponents);
        tmp_exponents.clear();
        ...
        libff::G2_vector<ppT> B_query = libff::batch_exp<libff::G2<ppT>, libff::Fr<ppT>>(
        ...
        libff::G1_vector<ppT> G_gamma2_Z_t = libff::batch_exp<libff::G1<ppT>, libff::Fr<ppT>>(
            libff::Fr<ppT>::size_in_bits(), G_window, G_table, tmp_exponents);
        tmp_exponents.clear();
#ifdef USE_MIXED_ADDITION
        ...
        libff::G1_vector<ppT> C_query_1 = libff::batch_exp<libff::G1<ppT>, libff::Fr<ppT>>(
            libff::Fr<ppT>::size_in_bits(), G_window, G_table, tmp_exponents);
        tmp_exponents.clear();
#ifdef USE_MIXED_ADDITION
        ...
        libff::G1_vector<ppT> C_query_2 = libff::batch_exp<libff::G1<ppT>, libff::Fr<ppT>>(
            libff::Fr<ppT>::size_in_bits(), G_window, G_table, tmp_exponents);
        tmp_exponents.clear();
#ifdef USE_MIXED_ADDITION
        ...
        r1cs_se_ppzksnark_proving_key<ppT> pk = r1cs_se_ppzksnark_proving_key<ppT>(
            std::move(A_query), std::move(B_query), std::move(C_query_1), std::move(C_query_2),
            G_gamma_Z, H_gamma_Z, G_ab_gamma_Z, G_gamma2_Z2, std::move(G_gamma2_Z_t),
            std::move(cs_copy));
     ...
     */
        libff::G1<ppT> A =
            ...
            libff::multi_exp<libff::G1<ppT>, libff::Fr<ppT>, libff::multi_exp_method_BDLO12>(
                pk.A_query.begin() + 1, pk.A_query.end(), sap_wit.coefficients_for_ACs.begin(),
                sap_wit.coefficients_for_ACs.end(), chunks);
     ...
     */
        libff::G2<ppT> B =
            ...
            libff::multi_exp<libff::G2<ppT>, libff::Fr<ppT>, libff::multi_exp_method_BDLO12>(
                pk.B_query.begin() + 1, pk.B_query.end(), sap_wit.coefficients_for_ACs.begin(),
                sap_wit.coefficients_for_ACs.end(), chunks);
     ...
     */
        libff::G1<ppT> C =
            libff::multi_exp<libff::G1<ppT>, libff::Fr<ppT>, libff::multi_exp_method_BDLO12>(
                pk.C_query_1.begin(), pk.C_query_1.end(),
            ...
            r * libff::multi_exp<libff::G1<ppT>, libff::Fr<ppT>, libff::multi_exp_method_BDLO12>(
                    pk.C_query_2.begin() + 1, pk.C_query_2.end(),
                    sap_wit.coefficients_for_ACs.begin(), sap_wit.coefficients_for_ACs.end(),
                    chunks) +
            sap_wit.d2 * pk.G_gamma2_Z_t[0] + // ZK-patch
            libff::multi_exp<libff::G1<ppT>, libff::Fr<ppT>, libff::multi_exp_method_BDLO12>(
                pk.G_gamma2_Z_t.begin(), pk.G_gamma2_Z_t.end(), sap_wit.coefficients_for_H.begin(),
                sap_wit.coefficients_for_H.end(), chunks);
     ...
     */
        libff::G1<ppT> G_psi =
            pvk.query[0] +
            libff::multi_exp<libff::G1<ppT>, libff::Fr<ppT>, libff::multi_exp_method_bos_coster>(
        ...
        libff::GT<ppT> test1 = ppT::final_exponentiation(test1_l.unitary_inverse() * test1_r1 *
                                                         test1_r2 * test1_r3);
     ...
     */
        libff::Fqk<ppT> test2_l = ppT::miller_loop(ppT::precompute_G1(proof.A), pvk.H_gamma_pc),
                        test2_r = ppT::miller_loop(pvk.G_gamma_pc, ppT::precompute_G2(proof.B));
        libff::GT<ppT> test2 = ppT::final_exponentiation(test2_l * test2_r.unitary_inverse());
    ...
    template<typename ppT>
    bool
    r1cs_se_ppzksnark_verifier_weak_IC(const r1cs_se_ppzksnark_verification_key<ppT> &vk,
                                       const r1cs_se_ppzksnark_primary_input<ppT> &primary_input,
                                       const r1cs_se_ppzksnark_proof<ppT> &proof)
    {
    ...
    template<typename ppT>
    bool
    r1cs_se_ppzksnark_verifier_strong_IC(const r1cs_se_ppzksnark_verification_key<ppT> &vk,
                                         const r1cs_se_ppzksnark_primary_input<ppT> &primary_input,
                                         const r1cs_se_ppzksnark_proof<ppT> &proof)
    {
