...
namespace libsnark
{
    ...
    bool
    r1cs_ppzksnark_proving_key<ppT>::operator==(const r1cs_ppzksnark_proving_key<ppT> &other) const
    {
    ...
    r1cs_ppzksnark_verification_key<ppT>::dummy_verification_key(const size_t input_size)
    {
        ...
        result.encoded_IC_query = accumulation_vector<libff::G1<ppT>>(std::move(base),
                                                                      std::move(v));
    ...
    r1cs_ppzksnark_generator(const r1cs_ppzksnark_constraint_system<ppT> &cs)
    {
        ...
        libff::window_table<libff::G1<ppT>> g1_table = get_window_table(
            libff::Fr<ppT>::ceil_size_in_bits(), g1_window, libff::G1<ppT>::one());
        ...
        libff::window_table<libff::G2<ppT>> g2_table = get_window_table(
            libff::Fr<ppT>::ceil_size_in_bits(), g2_window, libff::G2<ppT>::one());
        ...
        knowledge_commitment_vector<libff::G1<ppT>, libff::G1<ppT>> A_query = kc_batch_exp(
            libff::Fr<ppT>::ceil_size_in_bits(), g1_window, g1_window, g1_table, g1_table, rA,
            rA * alphaA, At, chunks);
        ...
        knowledge_commitment_vector<libff::G2<ppT>, libff::G1<ppT>> B_query = kc_batch_exp(
            libff::Fr<ppT>::ceil_size_in_bits(), g2_window, g1_window, g2_table, g1_table, rB,
            rB * alphaB, Bt, chunks);
        ...
        knowledge_commitment_vector<libff::G1<ppT>, libff::G1<ppT>> C_query = kc_batch_exp(
            libff::Fr<ppT>::ceil_size_in_bits(), g1_window, g1_window, g1_table, g1_table, rC,
            rC * alphaC, Ct, chunks);
        libff::leave_block("Compute the C-query", false);

        libff::enter_block("Compute the H-query", false);
        libff::G1_vector<ppT> H_query = batch_exp(libff::Fr<ppT>::ceil_size_in_bits(), g1_window,
                                                  g1_table, Ht);
        ...
        libff::G1_vector<ppT> K_query = batch_exp(libff::Fr<ppT>::ceil_size_in_bits(), g1_window,
                                                  g1_table, Kt);
#ifdef USE_MIXED_ADDITION
        ...
        libff::G1_vector<ppT> encoded_IC_values = batch_exp(
            libff::Fr<ppT>::ceil_size_in_bits(), g1_window, g1_table, multiplied_IC_coefficients);
        ...
        accumulation_vector<libff::G1<ppT>> encoded_IC_query(std::move(encoded_IC_base),
                                                             std::move(encoded_IC_values));

        r1cs_ppzksnark_verification_key<ppT> vk = r1cs_ppzksnark_verification_key<ppT>(
                          ...
                          const r1cs_ppzksnark_auxiliary_input<ppT> &auxiliary_input)
    {
        ...
        libff::G1<ppT> g_K = (pk.K_query[0] + qap_wit.d1 * pk.K_query[qap_wit.num_variables() + 1] +
        ...
        g_A = g_A + kc_multi_exp_with_mixed_addition<libff::G1<ppT>, libff::G1<ppT>, libff::Fr<ppT>,
        ...
        g_B = g_B + kc_multi_exp_with_mixed_addition<libff::G2<ppT>, libff::G1<ppT>, libff::Fr<ppT>,
                                                     libff::multi_exp_method_bos_coster>(
        ...
        g_C = g_C + kc_multi_exp_with_mixed_addition<libff::G1<ppT>, libff::G1<ppT>, libff::Fr<ppT>,
                                                     libff::multi_exp_method_bos_coster>(
        ...
        g_K = g_K + libff::multi_exp_with_mixed_addition<libff::G1<ppT>, libff::Fr<ppT>,
                                                         libff::multi_exp_method_bos_coster>(
        ...
        const r1cs_ppzksnark_proof<ppT> &proof)
    {
        ...
        const accumulation_vector<libff::G1<ppT>> accumulated_IC =
            pvk.encoded_IC_query.template accumulate_chunk<libff::Fr<ppT>>(primary_input.begin(),
                                                                           primary_input.end(), 0);
        ...
        libff::G1_precomp<ppT> proof_g_A_g_acc_C_precomp = ppT::precompute_G1((proof.g_A.g + acc) +
                                                                              proof.g_C.g);
    ...
    template<typename ppT>
    bool
    r1cs_ppzksnark_affine_verifier_weak_IC(const r1cs_ppzksnark_verification_key<ppT> &vk,
                                           const r1cs_ppzksnark_primary_input<ppT> &primary_input,
                                           const r1cs_ppzksnark_proof<ppT> &proof)
    {
        ...
        libff::affine_ate_G2_precomp<ppT> pvk_pp_G2_one_precomp = ppT::affine_ate_precompute_G2(
            libff::G2<ppT>::one());
        libff::affine_ate_G2_precomp<ppT> pvk_vk_alphaA_g2_precomp = ppT::affine_ate_precompute_G2(
            vk.alphaA_g2);
        libff::affine_ate_G1_precomp<ppT> pvk_vk_alphaB_g1_precomp = ppT::affine_ate_precompute_G1(
            vk.alphaB_g1);
        libff::affine_ate_G2_precomp<ppT> pvk_vk_alphaC_g2_precomp = ppT::affine_ate_precompute_G2(
            vk.alphaC_g2);
        libff::affine_ate_G2_precomp<ppT> pvk_vk_rC_Z_g2_precomp = ppT::affine_ate_precompute_G2(
            vk.rC_Z_g2);
        libff::affine_ate_G2_precomp<ppT> pvk_vk_gamma_g2_precomp = ppT::affine_ate_precompute_G2(
            vk.gamma_g2);
        ...
        libff::enter_block("Compute input-dependent part of A");
        const accumulation_vector<libff::G1<ppT>> accumulated_IC =
            vk.encoded_IC_query.template accumulate_chunk<libff::Fr<ppT>>(primary_input.begin(),
                                                                          primary_input.end(), 0);
        ...
        bool result = true;
        libff::enter_block("Check knowledge commitment for A is valid");
        libff::affine_ate_G1_precomp<ppT> proof_g_A_g_precomp = ppT::affine_ate_precompute_G1(
            proof.g_A.g);
        libff::affine_ate_G1_precomp<ppT> proof_g_A_h_precomp = ppT::affine_ate_precompute_G1(
            proof.g_A.h);
        ...
        libff::enter_block("Check knowledge commitment for B is valid");
        libff::affine_ate_G2_precomp<ppT> proof_g_B_g_precomp = ppT::affine_ate_precompute_G2(
            proof.g_B.g);
        libff::affine_ate_G1_precomp<ppT> proof_g_B_h_precomp = ppT::affine_ate_precompute_G1(
            proof.g_B.h);
        ...
        libff::enter_block("Check knowledge commitment for C is valid");
        libff::affine_ate_G1_precomp<ppT> proof_g_C_g_precomp = ppT::affine_ate_precompute_G1(
            proof.g_C.g);
        libff::affine_ate_G1_precomp<ppT> proof_g_C_h_precomp = ppT::affine_ate_precompute_G1(
            proof.g_C.h);
        ...
        libff::enter_block("Check QAP divisibility");
        libff::affine_ate_G1_precomp<ppT> proof_g_A_g_acc_precomp = ppT::affine_ate_precompute_G1(
            proof.g_A.g + acc);
        libff::affine_ate_G1_precomp<ppT> proof_g_H_precomp = ppT::affine_ate_precompute_G1(
            proof.g_H);
        ...
        libff::enter_block("Check same coefficients were used");
        libff::affine_ate_G1_precomp<ppT> proof_g_K_precomp = ppT::affine_ate_precompute_G1(
            proof.g_K);
        libff::affine_ate_G1_precomp<ppT> proof_g_A_g_acc_C_precomp = ppT::affine_ate_precompute_G1(
            (proof.g_A.g + acc) + proof.g_C.g);
