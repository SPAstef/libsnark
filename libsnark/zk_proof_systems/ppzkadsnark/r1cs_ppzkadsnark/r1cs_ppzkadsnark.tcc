...
namespace libsnark
{
    ...
    template<typename ppT>
    bool
    r1cs_ppzkadsnark_auth_data<ppT>::operator==(const r1cs_ppzkadsnark_auth_data<ppT> &other) const
    {
    ...
    r1cs_ppzkadsnark_auth_keys<ppT> r1cs_ppzkadsnark_auth_generator(void)
    {
        ...
        return r1cs_ppzkadsnark_auth_keys<ppT>(
            ...
            r1cs_ppzkadsnark_sec_auth_key<ppT>(std::move(i), std::move(sigkp.sk),
                                               std::move(prfseed)));
    }

    template<typename ppT>
    std::vector<r1cs_ppzkadsnark_auth_data<ppT>>
    r1cs_ppzkadsnark_auth_sign(const std::vector<libff::Fr<snark_pp<ppT>>> &ins,
                               ...
                               const r1cs_ppzkadsnark_pub_auth_prms<ppT> &prms)
    {
        ...
        const size_t g1_exp_count = 2 * (non_zero_At - qap_inst.num_inputs() + non_zero_Ct) +
...
#ifdef MULTICORE
        const size_t chunks =
            omp_get_max_threads(); // to override, set OMP_NUM_THREADS env var or call omp_set_num_threads()
#else
        ...
        libff::window_table<libff::G1<snark_pp<ppT>>> g1_table = get_window_table(
            libff::Fr<snark_pp<ppT>>::size_in_bits(), g1_window, libff::G1<snark_pp<ppT>>::one());
        ...
        libff::window_table<libff::G2<snark_pp<ppT>>> g2_table = get_window_table(
            libff::Fr<snark_pp<ppT>>::size_in_bits(), g2_window, libff::G2<snark_pp<ppT>>::one());
        ...
        r1cs_ppzkadsnark_verification_key<ppT> vk = r1cs_ppzkadsnark_verification_key<ppT>(
            alphaA_g2, alphaB_g1, alphaC_g2, gamma_g2, gamma_beta_g1, gamma_beta_g2, rC_Z_g2, A0,
            Ain);
        r1cs_ppzkadsnark_proving_key<ppT> pk = r1cs_ppzkadsnark_proving_key<ppT>(
            ...
            std::move(K_query), std::move(rA_i_Z_g1), std::move(cs_copy));
                            ...
                            const std::vector<r1cs_ppzkadsnark_auth_data<ppT>> &auth_data)
    {
        ...
        const qap_witness<libff::Fr<snark_pp<ppT>>> qap_wit = r1cs_to_qap_witness_map(
        ...
        knowledge_commitment<libff::G1<snark_pp<ppT>>, libff::G1<snark_pp<ppT>>> g_Ain =
        ...
        g_A = g_A +
              kc_multi_exp_with_mixed_addition<libff::G1<snark_pp<ppT>>, libff::G1<snark_pp<ppT>>,
        ...
        g_B = g_B +
              kc_multi_exp_with_mixed_addition<libff::G2<snark_pp<ppT>>, libff::G1<snark_pp<ppT>>,
                                               libff::Fr<snark_pp<ppT>>,
                                               libff::multi_exp_method_bos_coster>(
        ...
        g_H = g_H + libff::multi_exp<libff::G1<snark_pp<ppT>>, libff::Fr<snark_pp<ppT>>,
        ...
        g_K =
            g_K +
            libff::multi_exp_with_mixed_addition<libff::G1<snark_pp<ppT>>, libff::Fr<snark_pp<ppT>>,
                                                 libff::multi_exp_method_bos_coster>(
        ...
        muA = muA + libff::multi_exp<libff::G1<snark_pp<ppT>>, libff::Fr<snark_pp<ppT>>,
                                     libff::multi_exp_method_bos_coster>(
    ...
    r1cs_ppzkadsnark_verifier_process_vk(const r1cs_ppzkadsnark_verification_key<ppT> &vk)
    {
        ...
        libff::G2_precomp<snark_pp<ppT>> vk_rC_z_g2_precomp = snark_pp<ppT>::precompute_G2(
            vk.rC_Z_g2);
    ...
    template<typename ppT>
    bool
    r1cs_ppzkadsnark_online_verifier(const r1cs_ppzkadsnark_processed_verification_key<ppT> &pvk,
                                     ...
                                     const std::vector<labelT> &labels)
    {
        ...
        prodA = prodA + libff::multi_exp<libff::G1<snark_pp<ppT>>, libff::Fr<snark_pp<ppT>>,
                                         libff::multi_exp_method_bos_coster>(
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_Aau_g_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_Aau.g);
        libff::G1_precomp<snark_pp<ppT>> proof_g_Aau_h_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_Aau.h);
        libff::Fqk<snark_pp<ppT>> kc_Aau_1 = snark_pp<ppT>::miller_loop(proof_g_Aau_g_precomp,
                                                                        pvk.vk_alphaA_g2_precomp);
        libff::Fqk<snark_pp<ppT>> kc_Aau_2 = snark_pp<ppT>::miller_loop(proof_g_Aau_h_precomp,
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_A_g_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_A.g);
        libff::G1_precomp<snark_pp<ppT>> proof_g_A_h_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_A.h);
        libff::Fqk<snark_pp<ppT>> kc_A_1 = snark_pp<ppT>::miller_loop(proof_g_A_g_precomp,
                                                                      pvk.vk_alphaA_g2_precomp);
        libff::Fqk<snark_pp<ppT>> kc_A_2 = snark_pp<ppT>::miller_loop(proof_g_A_h_precomp,
                                                                      pvk.pp_G2_one_precomp);
        libff::GT<snark_pp<ppT>> kc_A = snark_pp<ppT>::final_exponentiation(
            kc_A_1 * kc_A_2.unitary_inverse());
        ...
        libff::G2_precomp<snark_pp<ppT>> proof_g_B_g_precomp = snark_pp<ppT>::precompute_G2(
            proof.g_B.g);
        libff::G1_precomp<snark_pp<ppT>> proof_g_B_h_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_B.h);
        libff::Fqk<snark_pp<ppT>> kc_B_1 = snark_pp<ppT>::miller_loop(pvk.vk_alphaB_g1_precomp,
                                                                      proof_g_B_g_precomp);
        libff::Fqk<snark_pp<ppT>> kc_B_2 = snark_pp<ppT>::miller_loop(proof_g_B_h_precomp,
                                                                      pvk.pp_G2_one_precomp);
        libff::GT<snark_pp<ppT>> kc_B = snark_pp<ppT>::final_exponentiation(
            kc_B_1 * kc_B_2.unitary_inverse());
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_C_g_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_C.g);
        libff::G1_precomp<snark_pp<ppT>> proof_g_C_h_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_C.h);
        libff::Fqk<snark_pp<ppT>> kc_C_1 = snark_pp<ppT>::miller_loop(proof_g_C_g_precomp,
                                                                      pvk.vk_alphaC_g2_precomp);
        libff::Fqk<snark_pp<ppT>> kc_C_2 = snark_pp<ppT>::miller_loop(proof_g_C_h_precomp,
                                                                      pvk.pp_G2_one_precomp);
        libff::GT<snark_pp<ppT>> kc_C = snark_pp<ppT>::final_exponentiation(
            kc_C_1 * kc_C_2.unitary_inverse());
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_H_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_H);
        libff::Fqk<snark_pp<ppT>> QAP_1 = snark_pp<ppT>::miller_loop(proof_g_Aacc_precomp,
                                                                     proof_g_B_g_precomp);
        ...
        libff::GT<snark_pp<ppT>> QAP = snark_pp<ppT>::final_exponentiation(
            QAP_1 * QAP_23.unitary_inverse());
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_K_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_K);
        libff::G1_precomp<snark_pp<ppT>> proof_g_Aacc_C_precomp = snark_pp<ppT>::precompute_G1(
            Aacc + proof.g_C.g);
        libff::Fqk<snark_pp<ppT>> K_1 = snark_pp<ppT>::miller_loop(proof_g_K_precomp,
        ...
        libff::Fqk<snark_pp<ppT>> K_23 = snark_pp<ppT>::double_miller_loop(
            ...
            proof_g_B_g_precomp);
        libff::GT<snark_pp<ppT>> K = snark_pp<ppT>::final_exponentiation(K_1 *
                                                                         K_23.unitary_inverse());
                                     ...
                                     const std::vector<labelT> &labels)
    {
        ...
        libff::G2_precomp<snark_pp<ppT>> g_minusi_precomp = snark_pp<ppT>::precompute_G2(
            pak.minusI2);
        ...
        libff::G1_precomp<snark_pp<ppT>> proof_g_muA_precomp = snark_pp<ppT>::precompute_G1(
            proof.muA);
        libff::G1_precomp<snark_pp<ppT>> proof_g_Aau_precomp = snark_pp<ppT>::precompute_G1(
            proof.g_Aau.g);
        ...
        libff::GT<snark_pp<ppT>> authPair = snark_pp<ppT>::final_exponentiation(
            accum * accum2.unitary_inverse());
